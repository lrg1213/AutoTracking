...
#define PUNISH_TIME             0       //罚时5秒
#define NUMBER_OF_TURNS         10       //规定完成圈数
#define PRODUCE_PROPRTY         100000   //道具随机产生的时间(ms)
#define WIGHT_OF_PITFALL        0       //陷阱宽度
#define WIGHT_OF_OUTSIDE_IMAGE  20      //出界标记的宽度
#define PROTECTED_TIME          0     //保护道具的有效时间(*100 ms)
#define SIZE_OF_OUTIMAGE        30      //定义出界图片边长
#define NUMBER_OF_FALSESTART    2       //抢跑次数上限 - 1
#define TIME_OF_PROPERTY        0      //道具作用时间
